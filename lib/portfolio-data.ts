...
const experience = {
  current: {
    company: "Top-tier global financial institution",
    note: "Cannot name publicly",
    role: "Software Engineer",
    duration: "4 years",
    highlights: [
      "Production systems at enterprise scale",
      "AI/ML infrastructure and platform work",
...
const skills = {
  languages: ["TypeScript", "Python", "Swift", "SQL", "JavaScript"],
  frontend: ["React 19", "Next.js 16", "SwiftUI", "Tailwind CSS 4", "Framer Motion", "Zustand"],
  backend: ["FastAPI", "Node.js", "Uvicorn", "SQLAlchemy"],
  ai_ml: [
  ...
  databases: ["PostgreSQL", "SQLite", "Neo4j", "ChromaDB", "Supabase"],
  infra: ["Docker", "Render", "Git", "XcodeGen"],
